...
| env.DID_METHOD_HOST_URL | string | `"0.0.0.0:8102"` |  |
| env.DID_METHOD_MODE | string | `"resolver"` |  |
| env.DID_METHOD_TLS_SYSTEMCERTPOOL | string | `"true"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"trustbloc/driver-did-trustbloc"` |  |
| image.tag | string | `""` |  |
